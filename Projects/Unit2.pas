...
begin
 ...
 // ShowMessage(FloatToStr(preco));
  ...
  if (com6 = 1) then
  // 'entrada com cartao para 30 dias + dinheiro na instalação'
  begin
  ...
  if (com6 = 2) then
  // 'entrada com cheque para 30 dias + dinheiro na instalação'
  begin
     resto:= preco/2;
    entrada := preco / 2 + (preco / 2 * 0.046);
    parcela := preco / 2;
  ...
  if (com6 = 3) then // 'entrada 2 vezes no cartao + dinheiro na instalação'
  begin
    resto := preco / 2;
  ...
  if (com6 = 4) then // 'entrada 3 vezes no cartao + dinheiro na instalação'
  begin
    resto := preco / 2;
  ...
  if (com6 = 5) then // 'entrada 4 vezes no cartao + dinheiro na instalação'
  begin
    resto := preco / 2;
  ...
  if (com6 = 6) then // 'entrada 5 vezes no cartao + dinheiro na instalação'
  begin
    resto := preco / 2;
  ...
  if (com6 = 7) then // 'entrada 6 vezes no cartao + dinheiro na instalação
  begin
    resto := preco / 2;
