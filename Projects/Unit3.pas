...
//iniciando variaveis
  ...
  quantidade:=3;
//definindo variaveis sem condição
  ...
  com12:=ComboBox12.ItemIndex;
     if (Com12=0) then    //boBox6.Text = 'entrada com dinheiro + restante a vista'
         ...
         begin
          ...
          if (Com12=1) then //boBox6.Text = 'entrada com cartao para 30 dias + dinheiro na instalação'
         begin
          ...
          if (Com12=2) then   //boBox6.Text = 'entrada com cheque para 30 dias + dinheiro na instalação'
         begin
         ...
         if (Com12=3) then //boBox6.Text = 'entrada 2 vezes no cartao + dinheiro na instalação'
         begin
            resto:=preco/2;
         ...
         if (Com12=4) then   //boBox6.Text = 'entrada 3 vezes no cartao + dinheiro na instalação'
         begin
           resto:=preco/2;
         ...
         if (Com12=5) then  //boBox6.Text = 'entrada 4 vezes no cartao + dinheiro na instalação'
         begin
           resto:=preco/2;
          ...
          if (Com12=6) then  //boBox6.Text = 'entrada 5 vezes no cartao + dinheiro na instalação'
         begin
           resto:=preco/2;
          ...
          if (Com12=7) then  //boBox6.Text = 'entrada 6 vezes no cartao + dinheiro na instalação'
         begin
            resto:=preco/2;
